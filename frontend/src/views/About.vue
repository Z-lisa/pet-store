<template>
  <div class="min-h-screen pb-20">
    <header class="bg-white shadow-sm sticky top-0 z-10">
      <div class="px-4 py-3">
        <h1 class="text-lg font-bold text-gray-800 text-center">关于我们</h1>
      </div>
    </header>
    ...
    <div class="p-4">
      ...
      <div class="bg-warm rounded-2xl p-6 mb-6 card-hover">
        <div class="flex items-center mb-4">
          ...
          <div>
            <h2 class="text-xl font-bold text-gray-800">温馨宠物店</h2>
            <p class="text-gray-500">成立于 2015 年</p>
          </div>
        </div>
        <p class="text-gray-600 leading-relaxed">
          温馨宠物店是一家专注于宠物全方位服务的专业店铺。我们致力于为宠物提供最优质的生活体验，为宠物主人提供最贴心的服务。店内环境温馨舒适，所有设施均采用宠物友好材料，确保毛孩子们的安全与健康。
        </p>
      </div>
      ...
      <!-- 店铺环境图 -->
      <div>
        <h3 class="text-lg font-bold text-gray-800 mb-4">店铺环境</h3>
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          >
            <img :src="image.src" :alt="image.alt" class="w-full h-32 object-cover">
